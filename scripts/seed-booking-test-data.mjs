...
const mockRows = [
  ...
  { id: 3, mockType: "SYS_DES", expLevel: 2, label: "System Design · 2 yr", price: 2999, rushPrice: 3499, currency: "INR" },
  { id: 4, mockType: "BEH_LED", expLevel: 2, label: "Behavioural / Leadership", price: 1799, rushPrice: 2199, currency: "INR" },
  { id: 5, mockType: "DSA", expLevel: 5, label: "DSA · 5+ yr (senior)", price: 3299, rushPrice: 3899, currency: "INR" },
  { id: 6, mockType: "ML", expLevel: 2, label: "ML / Data — 2 yr", price: 2699, rushPrice: 3199, currency: "INR" },
  { id: 7, mockType: "FRONTEND", expLevel: 2, label: "Frontend · React", price: 2199, rushPrice: 2599, currency: "INR" },
  { id: 8, mockType: "DEVOPS", expLevel: 3, label: "DevOps / Cloud", price: 2899, rushPrice: 3399, currency: "INR" },
];
